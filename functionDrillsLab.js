...
let nameGreating = nameCheck("Taggart")
...
function faveColorFinder(color1) {
  if (color1 === 'red'){
    ...
    return 'green is a soid favorite color'
...
//CODE HERE
let bestMovie = (movie1) => {return `${movie1} is the best movie ever!`}
...
let newWinners = theEliminator(contestants, loser)
...
//CODE HERE
function upperString(str1) {
  return str1.toUpperCase()
}
let upCase = upperString(sampleString)
...
function buyChocolateFrogs2(gold) {
  let maxFrogs2 = Math.floor(gold / 3)
...
let arrayIsAscending = isAccending(sampleArray)
